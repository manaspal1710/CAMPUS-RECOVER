# CAMPUS-RECOVER
Our solution for the Campus Lost & Found Portal tackles the primary reason lost items are rarely returned: a lack of motivation. We propose a gamified, secure platform that incentivizes honesty while prioritizing student safety.

When a student finds an item, they upload a partial photo and a "verification hint" (e.g., "What is the lock screen wallpaper?") to prevent false claims. Instead of coordinating risky peer-to-peer meetups, the finder securely drops the item at a designated college administration office.
